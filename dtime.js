function dtimes(a) {
    ...
    if (1 == b || 4 == b || 6 == b) {
        var c = new Date;
        c.setDate(c.getDate() + a + 1), document.write(c.getDate() + " " + months_localized[lang_locale][c.getMonth()])
    } else if (2 == b || 5 == b || 7 == b) {
        var c = new Date;
        c.setDate(c.getDate() + a + 1 - 1), document.write(c.getDate() + " " + months_localized[lang_locale][c.getMonth()])
    } else if (3 == b) {
        var c = new Date;
        c.setDate(c.getDate() + a + 1 - 2), document.write(c.getDate() + " " + months_localized[lang_locale][c.getMonth()])
    }
}

function dtime(a) {
    var b = new Date;
    b.setDate(b.getDate() + a + 1), document.write(days_localized[lang_locale][b.getDay()] + " " + b.getDate() + ",  " + months_localized[lang_locale][b.getMonth()] + " " + b.getFullYear())
}

function dtime_nums(a, b) {
    var c = new Date;
    c.setDate(c.getDate() + a + 1);
    var d = "";
    c.getDate() < 10 && (d = "0"), d += c.getDate();
    var e = "";
    c.getMonth() + 1 < 10 && (e = "0"), e += c.getMonth() + 1, !0 === b ? document.write(d + "." + e + "." + c.getFullYear()) : document.write(e + "." + d + "." + c.getFullYear())
}
months_localized = {
