(function($) {
    ...
    Landing.prototype.initEvents = function() {
        ...
        // $('input[name="phone"],input[name="name"]').on('focus', function () {
        //      $(this).next().show();
        //  }).on('blur', function () {
        //      {
        //          $(this).next('div').hide();
        ...
        // $('input[name="phone"],input[name="name"]').on('focus', $.proxy(this.showHelpers,this)).on('blur',$.proxy(this.showHelpers,this));
    };
